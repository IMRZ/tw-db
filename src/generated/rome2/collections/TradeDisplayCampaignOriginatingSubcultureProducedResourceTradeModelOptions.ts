...
export namespace TradeDisplayCampaignOriginatingSubcultureProducedResourceTradeModelOptions {
  export const KEY = new CollectionKey("trade_display_campaign_originating_subculture_produced_resource_trade_model_options");
