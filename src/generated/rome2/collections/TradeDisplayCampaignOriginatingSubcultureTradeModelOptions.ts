...
export namespace TradeDisplayCampaignOriginatingSubcultureTradeModelOptions {
  export const KEY = new CollectionKey("trade_display_campaign_originating_subculture_trade_model_options");
