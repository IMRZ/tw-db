...
export namespace TradeDisplayCampaignOriginatingCultureProducedResourceTradeModelOptions {
  export const KEY = new CollectionKey("trade_display_campaign_originating_culture_produced_resource_trade_model_options");
