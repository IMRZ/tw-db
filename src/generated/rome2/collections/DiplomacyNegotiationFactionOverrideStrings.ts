...
export namespace DiplomacyNegotiationFactionOverrideStrings {
  export const KEY = new CollectionKey("diplomacy_negotiation_faction_override_strings");
...
export default DiplomacyNegotiationFactionOverrideStrings;
