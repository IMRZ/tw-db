...
export namespace TradeDisplayCampaignOwningSubcultureProducedResourceTradeModelOptions {
  export const KEY = new CollectionKey("trade_display_campaign_owning_subculture_produced_resource_trade_model_options");
