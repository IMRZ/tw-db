...
export namespace TradeDisplayCampaignOriginatingCultureTradeModelOptions {
  export const KEY = new CollectionKey("trade_display_campaign_originating_culture_trade_model_options");
