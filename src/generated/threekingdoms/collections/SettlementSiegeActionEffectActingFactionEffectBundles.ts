...
export namespace SettlementSiegeActionEffectActingFactionEffectBundles {
  export const KEY = new CollectionKey("settlement_siege_action_effect_acting_faction_effect_bundles");
...
export default SettlementSiegeActionEffectActingFactionEffectBundles;
