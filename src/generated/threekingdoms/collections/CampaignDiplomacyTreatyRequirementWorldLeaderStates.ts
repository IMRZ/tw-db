...
export namespace CampaignDiplomacyTreatyRequirementWorldLeaderStates {
  export const KEY = new CollectionKey("campaign_diplomacy_treaty_requirement_world_leader_states");
  ...
  export class Entry {
    ...
    constructor(collectionCache: CollectionCache, values: any) {
      ...
      this.worldLeader = !!values["world_leader"];
    }
