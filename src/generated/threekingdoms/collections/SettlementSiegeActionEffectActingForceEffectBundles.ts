...
export namespace SettlementSiegeActionEffectActingForceEffectBundles {
  export const KEY = new CollectionKey("settlement_siege_action_effect_acting_force_effect_bundles");
...
export default SettlementSiegeActionEffectActingForceEffectBundles;
