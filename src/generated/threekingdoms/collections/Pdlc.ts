...
export namespace Pdlc {
  ...
  export class Entry {
    ...
    readonly isCustomBattleFilter: boolean;
    readonly optionalDlcIcon: string;
    ...
    constructor(collectionCache: CollectionCache, values: any) {
      ...
      this.isCustomBattleFilter = !!values["is_custom_battle_filter"];
      this.optionalDlcIcon = values["optional_dlc_icon"];
    }
