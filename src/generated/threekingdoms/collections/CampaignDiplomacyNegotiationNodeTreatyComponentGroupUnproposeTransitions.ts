...
export namespace CampaignDiplomacyNegotiationNodeTreatyComponentGroupUnproposeTransitions {
  export const KEY = new CollectionKey("campaign_diplomacy_negotiation_node_treaty_component_group_unpropose_transitions");
...
export default CampaignDiplomacyNegotiationNodeTreatyComponentGroupUnproposeTransitions;
