...
export namespace UnitSpecialAbilities {
  ...
  export class Entry {
    ...
    readonly vortexSpawnDelay: number;
    readonly _windUpStance: string;
    readonly hpCost: number;
    readonly hpCostIsPercentage: boolean;
    ...
    readonly splashAttackDamage: number;
    ...
    readonly projectileFireArc: number;
    ...
    constructor(collectionCache: CollectionCache, values: any) {
      ...
      this.vortexSpawnDelay = values["vortex_spawn_delay"];
      this._windUpStance = values["wind_up_stance"];
      this.hpCost = values["hp_cost"];
      this.hpCostIsPercentage = !!values["hp_cost_is_percentage"];
      ...
      this.splashAttackDamage = values["splash_attack_damage"];
      ...
      this.projectileFireArc = values["projectile_fire_arc"];
    }
