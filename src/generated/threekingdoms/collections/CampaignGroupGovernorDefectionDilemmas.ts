...
export namespace CampaignGroupGovernorDefectionDilemmas {
  export const KEY = new CollectionKey("campaign_group_governor_defection_dilemmas");
...
export default CampaignGroupGovernorDefectionDilemmas;
