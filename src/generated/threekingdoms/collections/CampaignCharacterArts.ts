...
export namespace CampaignCharacterArts {
  ...
  export class Entry {
    ...
    constructor(collectionCache: CollectionCache, values: any) {
      ...
      this.age = values["age"];
      this.hasComeOfAge = !!values["has_come_of_age"];
      ...
      this._fallbackCompositeDisplay = values["fallback_composite_display"];
    }
    ...
    get landAnimation(): CampaignCharacterAnimationSets.Entry | undefined {
      const collection = <CampaignCharacterAnimationSets.Entry[]>this.collectionCache.getCollection(CampaignCharacterAnimationSets.KEY, CampaignCharacterAnimationSets.Entry);
      return collection.find(entry => entry.key === this._landAnimation);
    }
    ...
    get fallbackCompositeDisplay(): UiDisplaySets.Entry | undefined {
      ...
      return collection.find(entry => entry.key === this._fallbackCompositeDisplay);
    }
  }
}
