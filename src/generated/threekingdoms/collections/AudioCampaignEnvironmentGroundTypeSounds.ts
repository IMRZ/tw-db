...
export namespace AudioCampaignEnvironmentGroundTypeSounds {
  export const KEY = new CollectionKey("audio_campaign_environment_ground_type_sounds");
...
export default AudioCampaignEnvironmentGroundTypeSounds;
