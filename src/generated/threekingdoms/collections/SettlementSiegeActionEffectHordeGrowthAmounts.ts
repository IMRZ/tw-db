...
export namespace SettlementSiegeActionEffectHordeGrowthAmounts {
  export const KEY = new CollectionKey("settlement_siege_action_effect_horde_growth_amounts");
...
export default SettlementSiegeActionEffectHordeGrowthAmounts;
