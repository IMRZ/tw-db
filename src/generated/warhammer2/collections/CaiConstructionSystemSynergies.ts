...
export namespace CaiConstructionSystemSynergies {
  ...
  export class Entry {
    ...
    get synergyScopeKey(): CaiConstructionSystemSynergyScopes.Entry | undefined {
      const collection = <CaiConstructionSystemSynergyScopes.Entry[]>this.collectionCache.getCollection(CaiConstructionSystemSynergyScopes.KEY, CaiConstructionSystemSynergyScopes.Entry);
