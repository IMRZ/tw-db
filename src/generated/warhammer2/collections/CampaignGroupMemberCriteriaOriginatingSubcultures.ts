...
export namespace CampaignGroupMemberCriteriaOriginatingSubcultures {
  export const KEY = new CollectionKey("campaign_group_member_criteria_originating_subcultures");
