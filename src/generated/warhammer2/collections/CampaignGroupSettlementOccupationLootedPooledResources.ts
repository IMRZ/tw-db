...
export namespace CampaignGroupSettlementOccupationLootedPooledResources {
  export const KEY = new CollectionKey("campaign_group_settlement_occupation_looted_pooled_resources");
...
export default CampaignGroupSettlementOccupationLootedPooledResources;
